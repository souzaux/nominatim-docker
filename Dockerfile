...
RUN wget --output-document=/app/data.pbf http://download.geofabrik.de/south-america/brazil-latest.osm.pbf
# RUN wget --output-document=/app/data.pbf http://download.geofabrik.de/europe/bulgaria-latest.osm.pbf
